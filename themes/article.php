...
<div class="article-layout">
    ...
    <div class="article-comments-sidebar" id="comments-sidebar">
        ...
        <div class="comment-form">
            <div id="quoted-preview" style="display:none;background:var(--bg);padding:8px 10px;border-radius:var(--radius);margin-bottom:6px;font-size:0.85rem;color:var(--text-muted);border-left:3px solid var(--accent);max-height:80px;overflow-y:auto;white-space:pre-wrap;position:relative;padding-right:28px;"><button onclick="clearQuotedText()" title="取消引用" style="position:absolute;top:4px;right:6px;background:var(--bg-card);border:1px solid var(--border);border-radius:3px;font-size:0.75rem;color:var(--text-muted);cursor:pointer;line-height:1.3;padding:1px 6px;">取消引用</button></div>
